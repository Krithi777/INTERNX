...
export default function MentorPage() {
  ...
  // Get task_id and user_id from URL params or localStorage
  ...
  if (!taskId) {
  return (
    <div style={{ color: "white", padding: 40, background: "#0f172a", height: "100vh" }}>
      ❌ No task selected. Please open a task first and then click "Ask Mentor".
    </div>
  );
}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            padding: "0 24px", background: "#3b82f6", color: "white",
